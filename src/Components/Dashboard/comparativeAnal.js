...
class comparativeAnal extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            timeType: ['Last 3 Months Data', 'Last 6 Months Data', 'Last 9 Months Data'],
            time_choosen: ''
         }
    }
    ...
    onSubmit = () => {
     // console.log(this.state.time_choosen);
        ...
        <div >
           ...
           <div style={{padding:'10px'}}>
             <FormControl style={{minWidth: 100,paddingRight: '20px'}}>  
                    ...
                    <MenuItem value="" disabled >Select Date Range</MenuItem>   
