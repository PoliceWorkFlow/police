...
export default function CustomizedTables(props) {
  ...
  const rows = [
    ...
    createData('Sri Chamkaur Sahib', props.report[5].caseincourt, props.report[5].propDisp, props.report[3].heniusCrime, props.report[5].POarrested, props.report[5].propCrime, props.report[5].untraceInCourt, props.report[5].compDisp),
  ...
  const rows2 = [
    ...
    createData('Sri Chamkaur Sahib', props.report[5].ndps, props.report[5].arm, props.report[3].excise, props.report[5].gambling, props.report[5].commercial, props.report[5].feedback, props.report[5].handling, props.report[5].cleaniness),
